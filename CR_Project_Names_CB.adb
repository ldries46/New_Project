...
package body CR_Project_Names_CB is

   -----------------------------------------------------------------------------
   -- Procedure On Dialog_End used in the Destroy command                     --
   -----------------------------------------------------------------------------
   procedure On_Names_End (Object : access Gtk_Button_Record'Class) is
      pragma Unreferenced (Object);
   begin
      if CR_Project_Names_Init.Dialog_Open then
         CR_Project_Names_Init.Main_Dialog.Hide;
         CR_Project_Names_Init.Dialog_Open := false;
      end if;
   end On_Names_End;
   ...
   -----------------------------------------------------------------------------
   function On_Names_Delete_Event (Object : access Gtk_Dialog_Record'Class;
                                    Event : Gdk.Event.Gdk_Event) return boolean is
      pragma Unreferenced (Object);
   begin
      On_Names_End(null);
      return true;
   end On_Names_Delete_Event;
   ...
   begin
      ...
      --                                                                      --
      --------------------------------------------------------------------------
      last_template := To_Unbounded_String(Get_Text(CR_Project_Names_Init.Main_Dialog.Template_Entry));
      last_dialog := To_Unbounded_String(Get_Text(CR_Project_Names_Init.Main_Dialog.Dialog_Entry));
      Type_conv := Full;
      On_Names_End(null);
      Conversion;
   end On_OK;

end CR_Project_Names_CB;
