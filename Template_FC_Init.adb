...
with Template_FC_CB; use Template_FC_CB;
...
package body Template_FC_Init is
   ...
   begin
      ...
      File_Open_Dialog := Gtk_File_Chooser_Dialog_New
        (Open_Title, Template_Dialog_Init.Main_Dialog, Action_Open);
   ...
   begin
      ...
      File_Save_Dialog := Gtk_File_Chooser_Dialog_New
        (Save_As_Title, Template_Dialog_Init.Main_Dialog, Action_Save);
   ...
   begin
      ...
      File_Dir_Dialog := Gtk_File_Chooser_Dialog_New
        (Dir_Title, Template_Dialog_Init.Main_Dialog, Action_Select_Folder);
