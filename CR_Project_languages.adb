...
with CR_Project_Languages_Dialog_CB;   use CR_Project_Languages_Dialog_CB;

package body CR_Project_Languages is
   ...
   begin
      ...
      CR_Project_Names_Init.Main_Dialog.Set_Title (To_String(Lan_Dialog_Title(Lan)));
      ...
      -- CR_Project_Main Dialog
      CR_Project_Names_Init.Main_Dialog.OK.Set_Label(To_String(Lan_OK(Lan)));
      CR_Project_Names_Init.Main_Dialog.Cancel.Set_Label(To_String(Lan_Cancel(Lan)));
      -- Language Dialog
