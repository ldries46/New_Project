...
package body CR_Project_Languages_Dialog_Init is
   ...
   begin
      ...
      CR_Project_Languages_Dialog_Init.Init (LanDialog);
   end Gtk_New;
   ...
   begin
      ...
      Dialog_CBR.Connect(LanDialog, "delete_event",
                         Dialog_CBR.To_Marshaller(On_DialogDelete_Event'Access));
...
end CR_Project_Languages_Dialog_Init;
