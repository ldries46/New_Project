...
with Template_Dialog_Init; use Template_Dialog_Init;

package Template_Main_Init is
   ...
   type Main_Window_Record is new Gtk_Window_Record with record
      ...
      Template         : Gtk_Menu_Item;           -- Template Menu in Menubalk
      Template_Menu    : Gtk_Menu;
      Test             : Gtk_Menu_Item;           -- Test in Template menu
